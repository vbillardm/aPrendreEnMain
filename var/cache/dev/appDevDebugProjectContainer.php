...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'userlistener' => 'getUserlistenerService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+aFTo0sMkH', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YteEFwMlhf', 0, 'wEakyLzsN5fJdcvN3-qNTL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('userlistener', 'AcceuilBundle\\EventListener\\UserListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'a', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/AcceuilBundle/Entity'))), 'AcceuilBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('AcceuilBundle' => 'AcceuilBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f5fa4a1be1da2a5017c954a38500e34b5b13cb069f9f92b1489e42363b84c257');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('AcceuilBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('AcceuilBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('AcceuilBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('AcceuilBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'AcceuilBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('DGcjD5okFB', NULL, 'wEakyLzsN5fJdcvN3-qNTL', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m->add($k, array(0 => 'ROLE_MEMBRE'), NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('fos_csrf_provider', $this->get('security.csrf.token_manager'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/AcceuilBundle/Resources/views'), 'Acceuil');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f676272985a09243bfe115806af6d6d0ad65ebcc');
    }

    /**
     * Gets the 'userlistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AcceuilBundle\EventListener\UserListener A AcceuilBundle\EventListener\UserListener instance
     */
    protected function getUserlistenerService()
    {
        return $this->services['userlistener'] = new \AcceuilBundle\EventListener\UserListener($this->get('fos_user.user_manager'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cKEHFOw9Xt', 0, 'wEakyLzsN5fJdcvN3-qNTL', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_MEMBRE'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AcceuilBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AcceuilBundle'),
                    'namespace' => 'AcceuilBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcceuilBundle' => 'AcceuilBundle\\AcceuilBundle',
            ...
            'secret' => 'f676272985a09243bfe115806af6d6d0ad65ebcc',
            'user.class' => 'AcceuilBundle\\Entity\\User',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f676272985a09243bfe115806af6d6d0ad65ebcc',
            ...
            'fos_user.model.user.class' => 'AcceuilBundle\\Entity\\User',
